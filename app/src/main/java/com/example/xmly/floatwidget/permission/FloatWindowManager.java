 ...
 */
package com.example.xmly.floatwidget.permission;
...
import com.example.xmly.floatwidget.permission.rom.HuaweiUtils;
import com.example.xmly.floatwidget.permission.rom.MeizuUtils;
import com.example.xmly.floatwidget.permission.rom.MiuiUtils;
import com.example.xmly.floatwidget.permission.rom.OppoUtils;
import com.example.xmly.floatwidget.permission.rom.QikuUtils;
import com.example.xmly.floatwidget.permission.rom.RomUtils;
...
//                floatView.getLocationInWindow(positionArray);
//                Log.i(TAG, "run: -----"+positionArray[0]+"-----"+positionArray[1]);
//                CommonApplication.setIntX((int) (mParams.x + context.getResources().getDimension(R.dimen.x50)));
//                CommonApplication.setIntY((int) (mParams.y + context.getResources().getDimension(R.dimen.x50)));
    }
