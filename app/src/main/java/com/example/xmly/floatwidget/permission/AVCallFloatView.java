...
import com.example.xmly.floatwidget.R;
...
public class AVCallFloatView extends FrameLayout {
    ...
    private void initView() {
        ...
        View floatView = inflater.inflate(R.layout.float_view, null);
        addView(floatView);
        ...
        switch (event.getAction()) {
            ...
            case MotionEvent.ACTION_UP:
                if (Math.abs(xDownInScreen - xInScreen) <= ViewConfiguration.get(getContext()).getScaledTouchSlop()
                    ...
                    // 点击效果
                    Toast.makeText(getContext(), "点击了悬浮框", Toast.LENGTH_SHORT).show();
                } else {
                    //吸附效果
                    anchorToSide();
                }
...
//            }else{
//                CommonApplication.setIntX((int) (mParams.x + context.getResources().getDimension(R.dimen.x40)));
//                CommonApplication.setIntY((int) (mParams.y + context.getResources().getDimension(R.dimen.x40)));
//            }
